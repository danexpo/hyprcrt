...
// the preset a fresh install starts from: applyPreset(DEFAULT_PRESET, k) is the default look, in both modes
// >>> generated by tools/crt-presets: the default preset, from presets/*.conf
inline constexpr const char* DEFAULT_PRESET = "monitor";
// <<< generated
